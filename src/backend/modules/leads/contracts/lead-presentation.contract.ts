...
export const leadSummaryItemV1Schema = z.object({
  ...
  contact: z.object({ contactId: uuid.nullable(), maskedEmail: nullableBounded(320), maskedPhone: nullableBounded(32) }).strict(),
  ...
  capabilities: z.object({ canView: z.literal(true), canEdit: z.literal(false) }).strict(),

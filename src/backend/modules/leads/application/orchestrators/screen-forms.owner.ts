      ...
      async (operationId) => {
        ...
        const intake = (
            await tx.query<{ id: string }>(
              `insert into lead_intakes(workspace_id,intake_channel,idempotency_key,actor_membership_id,request_hash,contract_version,normalization_version,attribution_contract_version,source_category,source_medium,state,lead_id,outcome) values($1,'manual',$2,$3,$4,'lead-inquiry-intake.v1','p1a-identity-v2','p1a-attribution-v1',$5,'unknown','committed',$6,'{}') returning id`,
              [
                actor.workspaceId,

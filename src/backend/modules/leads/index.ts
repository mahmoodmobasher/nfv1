...
export { getLeadDetailV1, listLeadSummariesV1, parseLeadSummaryFiltersV1 } from "./application/queries/lead-presentation.query";
...
export type { LeadDetailViewV1, LeadSummariesViewV1, LeadSummaryFiltersV1,
  LeadSummaryItemV1 } from "./contracts/lead-presentation.contract";

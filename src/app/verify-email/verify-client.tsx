...
export function VerifyClient({hasIntent,invalidIntent,continuation}:{hasIntent:boolean;invalidIntent:boolean;continuation:string|null}) {
  ...
  const aside=continuation?<aside className="plan-summary"><p className="eyebrow">Workspace invitation</p><h2>Invitation account verification</h2><p>Email verification only activates your account. Review and accept the token-bound invitation after you sign in.</p></aside>:<PlanSummary/>;

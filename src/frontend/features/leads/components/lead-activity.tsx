...
export function LeadActivityPanel({ workspaceId, leadId, onAuthorityLoss }: { workspaceId: string; leadId: string; onAuthorityLoss: (error: AuthorityLoss) => void }) {
  ...
  return <Panel tone="activity" className="lead-activity" title="Activity" description="Manual Lead interactions in newest-first order." action={view.lead.capabilities.canCreateActivity ? <span className="lead-activity-capability">You can log activity</span> : undefined}>

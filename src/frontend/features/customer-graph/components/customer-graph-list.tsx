...
import { ActionLink, ActionMenu, Button, DataTable, EmptyState, FeedbackState, ProductPageHeader, RecordCard, RecordCards, StatusBadge } from "@/frontend/design-system";
import {
  COMPANY_LIFECYCLE,
  CONTACT_LIFECYCLE,
...
export function CustomerGraphListPage({ workspaceId, kind }: { workspaceId: string; kind: CustomerGraphKind }) {
  ...
  return <div className="cg-directory">
    ...
    <section className="cg-directory-tools ds-list-toolbar" aria-label={`${title(kind)} filters`}>

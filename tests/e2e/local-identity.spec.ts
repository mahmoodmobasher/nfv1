...
const database = new Pool({ connectionString: "postgres://nexaflow:nexaflow@127.0.0.1:54329/nexaflow" });
...
test("local OIDC fixture provisions a server-derived sole-Owner workspace and survives refresh", async ({ page }) => {
  ...
  const mobileMenu = page.locator("#mobile-crm-menu");

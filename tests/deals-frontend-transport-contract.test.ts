...
const stage = { stageId: ids.stage, pipelineId: ids.pipeline, code: "sales.qualification", label: "Qualification", outcomeClass: "open", sortKey: 1, defaultProbabilityBps: 1000, version: 1 } as const;
